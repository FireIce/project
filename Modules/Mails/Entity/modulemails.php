...
namespace pit\Modules\Mails\Entity;
...
class modulemails
{
    ...
    {
        return array (
            0 => array ('type' => 'text', 'name' => 'date', 'title' => 'Дата'),
            1 => array ('type' => 'text', 'name' => 'name', 'title' => 'Имя'),
            2 => array ('type' => 'text', 'name' => 'email', 'title' => 'Электронный адрес'),
            3 => array ('type' => 'text', 'name' => 'comment', 'title' => 'Сообщение'),
        );
    }
